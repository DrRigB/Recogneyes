...
public class ConnectedComponents
{
    ...
    */
    ...
    public void RenderBlobs(Mat img)
    {
        ...
        var height = LabelCount; // Labels.GetLength(0);
        var width = LabelCount; // Labels.GetLength(1);
...
#pragma warning restore CA1024
    ...
    {
        var rows = LabelCount; // Labels.GetLength(0);
        var cols = LabelCount; // Labels.GetLength(1);
        using (var labels = new Mat(rows, cols, MatType.CV_32SC1, null)) // Labels.GetBuffer()
